...
namespace JiraTimeBot.Core.TaskTime
{
    public class TaskTimeByCommitsCalculator: ITaskTimeCalculator
    {
        ...
        public List<TaskTimeItem> CalculateTaskTime(List<MercurialCommitItem> commits,
                                                    Settings settings,
                                                    CancellationToken cancellationToken = default)
        {
            ...
            {
                //если переборщили или не достаточно добавили до 8 часов - скорректируем остаток в первой задаче (она самая трудозатратная).
